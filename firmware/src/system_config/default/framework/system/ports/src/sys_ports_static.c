...
//    PLIB_PORTS_ChannelChangeNoticePullDownEnable(PORTS_ID_0, PORT_CHANNEL_K, SYS_PORT_K_CNPD);
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_C2RX, INPUT_PIN_RPD4 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1RX, INPUT_PIN_RPC14 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_INT4, INPUT_PIN_RPB1 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_C1TX, OUTPUT_PIN_RPF1 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_C2TX, OUTPUT_PIN_RPD5 );
