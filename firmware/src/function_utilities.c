...
void DRINKOUT_Spin(unsigned char ID, int goal_pos){
    unsigned char send_data[16];
    ...
    unsigned short Check_bytes = update_crc(0,&send_data[0],14);
...
void DRINKOUT_DoorWork(unsigned char ID, int goal_pos){
    unsigned char send_data[16];
